...
//  KennyYakalaApp
//
//  Created by Osman Yıldız on 21.02.2021.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let gesture1 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture2 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture3 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture4 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture5 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture6 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture7 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture8 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
        let gesture9 = UITapGestureRecognizer(target: self, action: #selector(kennyTouched))
